  ...
  return (
    <button
      className={cn(
        ...
        "before:border-x-[9px] before:border-t-[10px] before:border-b-0 before:border-solid",
        ...
        "after:border-x-[8px] after:border-t-[9px] after:border-b-0 after:border-solid",
