...
const FloatingIconButton = ({
  ...
  return (
    <button
      ...
      className={cn(
        "absolute z-elevated flex cursor-pointer items-center justify-center rounded-[0.8rem] border-none p-[0.8rem] shadow-floating backdrop-blur-[1rem] disabled:cursor-not-allowed",
